    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followedby', models.ManyToManyField(blank=True, related_name='followed_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.postcaption')),
            ],
        ),
    ]
